...
// Validate ../../src/app/api/success/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/success">> = Specific
  const handler = {} as typeof import("../../src/app/api/success/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
